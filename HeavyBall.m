...
% global variables
global gamma lambda gamma_0 gamma_1 lambda_0 lambda_1 c_0 c_10 V0 V1 delta alpha cTilde_0 cTilde_10 d_0 d_10 M
%%%%%%%%%%%%%%%%%%%%%
% setting the globals
%%%%%%%%%%%%%%%%%%%%%
...
c_0 = 2000; % \mathcal{U}_0 
c_10 = 1351.9505; % \mathcal{T}_{1,0} 1586.3255
...
semilogy(tOscillate,lOscillate,'Color',[0.4940 0.1840 0.5560],'LineWidth',1.5,'LineStyle','--');
...
plot(tOscillate,lOscillate,'Color',[0.4940 0.1840 0.5560],'LineWidth',1.5,'LineStyle',':');
